...
def test_tfp_growth():
    ...
    # Test with sample data from the model
    next_tfp = calculate_tfp_growth(current_tfp=1.0, openness_ratio=0.3, fdi_ratio=0.05, g=0.02, theta=0.10, phi=0.08)
...
def test_with_dataframe():
    ...
    df = calculate_exports_dataframe(
        df, exchange_rate_col="exchange_rate", foreign_income_col="Y_star", x_0=19.41, e_0=1.5, y_star_0=1000.0
    )
    ...
    df = calculate_imports_dataframe(
        df, exchange_rate_col="exchange_rate", domestic_income_col="GDP_USD_bn", m_0=21.84, e_0=1.5, y_0=300.0
    )
