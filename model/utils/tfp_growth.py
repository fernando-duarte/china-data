...
def calculate_tfp_growth(
    current_tfp: Union[float, pd.Series],
    openness_ratio: Union[float, pd.Series],
    fdi_ratio: Union[float, pd.Series],
    *,
    g: float = 0.02,
    theta: float = 0.10,
    phi: float = 0.08,
...
def calculate_tfp_sequence(
    ...
    *,
    ...
    for i, (openness, fdi) in enumerate(zip(openness_sequence, fdi_sequence)):
