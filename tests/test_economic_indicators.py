...
class TestCalculateEconomicIndicators:
    ...
    def test_private_savings_calculation(self, complete_data):
        ...
        expected_priv_savings = (complete_data['GDP_USD_bn'] - 
                                result['T_USD_bn'] - 
                                complete_data['C_USD_bn'])
    ...
    def test_all_indicators_present(self, complete_data):
        ...
        expected_columns = [
            'NX_USD_bn', 'K_Y_ratio', 'TFP', 'T_USD_bn',
            'Openness_Ratio', 'S_USD_bn', 'S_priv_USD_bn',
            'S_pub_USD_bn', 'Saving_Rate'
        ]
