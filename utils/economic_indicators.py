...
def calculate_tfp(data: pd.DataFrame, alpha: float = 1 / 3) -> pd.DataFrame:
    """
...
def calculate_economic_indicators(merged: pd.DataFrame, alpha: float = 1 / 3, logger: Optional[logging.Logger] = None) -> pd.DataFrame:
    """
