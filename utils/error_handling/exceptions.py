...
class DataDownloadError(ChinaDataError):
    ...
    def __init__(self, source: str, indicator: str, message: str, original_error: Exception | None = None):
        self.source = source
...
class DataValidationError(ChinaDataError):
    ...
    def __init__(self, column: str, message: str, data_info: str | None = None):
        self.column = column
...
class ProjectionError(ChinaDataError):
    ...
    def __init__(self, method: str, column: str, message: str, original_error: Exception | None = None):
        self.method = method
        self.column = column
        self.original_error = original_error
...
class FileOperationError(ChinaDataError):
    ...
    def __init__(self, operation: str, filepath: str, message: str, original_error: Exception | None = None):
